...
export const Independent_ECOSYSTEM = {
  ...
  PUBLIC_MOBILE_APP: {
    ...
    name_ar: "Ø¬ÙŠÙ…ÙŠÙ†Ø§ÙŠ Ø¬ÙŠØ¨",
    tagline_ar: "ØªØ·Ø¨ÙŠÙ‚Ù†Ø§ Ù„Ù„Ù…ØªØ§Ø¨Ø¹Ø© Ø§Ù„Ø³Ø±ÙŠØ±ÙŠØ©",
    ...
    leadership: [
        {
            id: 'GA-000',
            name: { en: 'Dr. Mohamed Gibbril', ar: 'Ø¯. Ù…Ø­Ù…Ø¯ Ø£Ø­Ù…Ø¯ Ø¬Ø¨Ø±ÙŠÙ„' },
            role: { en: 'Founder & Chief Executive Officer', ar: 'Ø§Ù„Ù…Ø¤Ø³Ø³ ÙˆØ§Ù„Ø±Ø¦ÙŠØ³ Ø§Ù„ØªÙ†ÙÙŠØ°ÙŠ' },
        ...
        {
            id: 'GA-001',
            name: { en: 'Dr. Alaa Mursi Elnour', ar: 'Ø¯. Ø¹Ù„Ø§Ø¡ Ù…Ø±Ø³ÙŠ Ø§Ù„Ù†ÙˆØ±' },
            role: { en: 'Co-Founder & Academic Lead (COO)', ar: 'Ø§Ù„Ù…Ø¤Ø³Ø³ Ø§Ù„Ø´Ø±ÙŠÙƒ ÙˆØ§Ù„Ù…Ø¯ÙŠØ± Ø§Ù„Ø£ÙƒØ§Ø¯ÙŠÙ…ÙŠ (COO)' },
        ...
        {
            id: 'GA-004',
            name: { en: 'Dr. Safaa El Hassan', ar: 'Ø¯. ØµÙØ§Ø¡ Ø¹Ø¨Ø¯ Ø§Ù„Ù‚Ø§Ø¯Ø± Ø§Ù„Ø­Ø³Ù†' },
            role: { en: 'Senior Academic Officer', ar: 'Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„ Ø§Ù„Ø£ÙƒØ§Ø¯ÙŠÙ…ÙŠ Ø§Ù„Ø£ÙˆÙ„' },
            ...
            status: 'Assigned Lifecycle 2025â€“2026 (Operational Year 2)'
        },
        {
            id: 'GA-011',
            name: { en: 'Amjad Gorashi', ar: 'Ù…. Ø£Ù…Ø¬Ø¯ Ù‚Ø±Ø´ÙŠ Ø­Ø³Ù†' },
            role: { en: 'Operations & Systems Logistics Officer', ar: 'Ù…Ø³Ø¤ÙˆÙ„ Ø§Ù„Ø¹Ù…Ù„ÙŠØ§Øª ÙˆØ§Ù„Ø£Ù†Ø¸Ù…Ø© ÙˆØ§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª' },
    ...
    faculty: [
        {
            ...
            name_ar: 'Ø¯. Ù…Ø­Ù…Ø¯ Ø£Ø­Ù…Ø¯ Ø¬Ø¨Ø±ÙŠÙ„',
            role: 'Founder & CEO | Systems Architect',
            role_ar: 'Ø§Ù„Ù…Ø¤Ø³Ø³ ÙˆØ§Ù„Ø±Ø¦ÙŠØ³ Ø§Ù„ØªÙ†ÙÙŠØ°ÙŠ | Ø§Ù„Ù…Ø¹Ù…Ø§Ø±ÙŠØ© Ø§Ù„Ù…Ø¹Ø±ÙÙŠØ© ÙˆØ§Ù„Ø£Ù†Ø¸Ù…Ø©',
            degrees: 'MBBS (KU 0089958, 2021), MSc Molecular Medicine',
            pillar: 'GemIInI & Gene Core',
        ...
        },
        {
            ...
            name_ar: 'Ø¯. Ø¹Ù„Ø§Ø¡ Ù…Ø±Ø³ÙŠ Ø§Ù„Ù†ÙˆØ± (FRCSI)',
            role: 'Co-Founder & Academic Lead (COO)',
            role_ar: 'Ø§Ù„Ù…Ø¤Ø³Ø³ Ø§Ù„Ø´Ø±ÙŠÙƒ ÙˆØ§Ù„Ù…Ø¯ÙŠØ± Ø§Ù„Ø£ÙƒØ§Ø¯ÙŠÙ…ÙŠ (COO)',
            degrees: 'MBBS, FRCSI (Letterkenny University Hospital, Ireland)',
            pillar: 'GemIInI Clinical Lead',
        ...
        },
        {
            ...
            name_ar: 'Ø¯. ØµÙØ§Ø¡ Ø¹Ø¨Ø¯ Ø§Ù„Ù‚Ø§Ø¯Ø± Ø§Ù„Ø­Ø³Ù†',
            role: 'Senior Academic Officer',
            role_ar: 'Ø§Ù„Ù…Ø³Ø¤ÙˆÙ„ Ø§Ù„Ø£ÙƒØ§Ø¯ÙŠÙ…ÙŠ Ø§Ù„Ø£ÙˆÙ„',
        ...
        },
        {
            id: 'GA-011',
            name: 'Amjad Gorashi',
            name_ar: 'Ù…. Ø£Ù…Ø¬Ø¯ Ù‚Ø±Ø´ÙŠ Ø­Ø³Ù†',
            role: 'Operations & Systems Logistics Officer',
            role_ar: 'Ù…Ø³Ø¤ÙˆÙ„ Ø§Ù„Ø¹Ù…Ù„ÙŠØ§Øª ÙˆØ§Ù„Ø£Ù†Ø¸Ù…Ø© ÙˆØ§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª',
    ...
    metrics: {
        ...
        registryDisplay: '1,200 GA-ID verified Â· 2,441 total enrolled',
    ...
    pricing: {
        ...
        sudan: '3,000 â€“ 5,000 SDG',
        egyptDiaspora: '100 â€“ 150 EGP / ~$2.50 USD',
    ...
    reviews: [
        {
            ...
            rating: 5,
            quote: 'Ø§Ù„Ù…Ù†Ù‡Ø¬ÙŠØ© Ø§Ù„Ù…ØªØ¨Ø¹Ø© ÙÙŠ Ø±Ø¨Ø· Ø§Ù„Ø¢Ù„ÙŠØ© Ø§Ù„Ø­ÙŠÙˆÙŠØ© Ø¨Ø§Ù„Ù‚Ø±Ø§Ø± Ø§Ù„Ø³Ø±ÙŠØ±ÙŠ (MTC) ØºÙŠØ±Øª ØªÙ…Ø§Ù…Ø§Ù‹ Ø·Ø±ÙŠÙ‚Ø© Ø¥Ø¬Ø§Ø¨ØªÙŠ ÙÙŠ Ø§Ù…ØªØ­Ø§Ù†Ø§Øª Ø§Ù„Ù…Ø¬Ù„Ø³ Ø§Ù„Ø·Ø¨ÙŠ. Ù„Ù… Ø£Ø¹Ø¯ Ø£Ø­ÙØ¸ Ø¨Ù„ Ø£ØµØ¨Ø­Øª Ø£ÙÙ‡Ù… Ø§Ù„ØªØ³Ù„Ø³Ù„ Ø§Ù„Ø¥Ù…Ø±Ø§Ø¶ÙŠ Ø¨Ø¯Ù‚Ø©.',
        ...
        },
        {
            ...
            rating: 5,
            quote: 'Ø§Ù„ØªØ¯Ø±ÙŠØ¨ Ø§Ù„Ø¹Ù…Ù„ÙŠ Ø§Ù„Ø¬Ø±Ø§Ø­ÙŠ ÙÙŠ Ø§Ù„Ù‚Ø§Ù‡Ø±Ø© Ø¨Ø¥Ø´Ø±Ø§Ù Ø¯. Ø¹Ù„Ø§Ø¡ Ù…Ø±Ø³ÙŠ ÙƒØ§Ù† Ù†Ù‚Ø·Ø© ØªØ­ÙˆÙ„ ÙÙŠ Ø§Ù„ØªØ¹Ø§Ù…Ù„ Ù…Ø¹ Ø§Ù„Ø£Ø¯ÙˆØ§Øª ÙˆØ®ÙŠØ§Ø·Ø© Ø§Ù„Ø£Ù…Ø¹Ø§Ø¡ ÙˆØ§Ù„Ø£ÙˆØ¹ÙŠØ© Ø§Ù„Ø¯Ù‚ÙŠÙ‚Ø©.',
        ...
        },
        {
            ...
            rating: 5,
            quote: 'Ø§Ù„ØªÙˆØ«ÙŠÙ‚ Ø§Ù„Ø£ÙƒØ§Ø¯ÙŠÙ…ÙŠ ÙˆÙ…Ø¬Ù…ÙˆØ¹Ø§Øª Ø§Ù„Ø¨Ø­Ø« 15:5:1 ÙØªØ­Øª Ø¢ÙØ§Ù‚Ø§Ù‹ Ø­Ù‚ÙŠÙ‚ÙŠØ© Ù„Ø±Ø¨Ø· Ø§Ù„Ø¨Ø§Ø­Ø«ÙŠÙ† Ø§Ù„Ø³ÙˆØ¯Ø§Ù†ÙŠÙŠÙ† Ø¨Ù‚ÙˆØ§Ø¹Ø¯ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø¹Ø§Ù„Ù…ÙŠØ© ÙˆØ§Ù„Ù…Ø¬Ù„Ø§Øª Ø§Ù„Ù…ØµÙ†ÙØ© Scopus Q1.',
